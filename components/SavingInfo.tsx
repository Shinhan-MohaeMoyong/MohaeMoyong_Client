...
export default function SavingInfo({
  ...
  // 주차별 저축 금액의 최대값 계산
  const maxAmount = Math.max(...weeklySavings.map(s => s.amount));
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.graphContainer}>
        ...
        <View style={styles.graphContent}>
          ...
          <View style={styles.barsContainer}>
            {weeklySavings.map((saving, index) => (
      ...
      <View style={styles.goalContainer}>
        <Text style={styles.goalText}>* 목표 기간: {goalPeriod}</Text>
      ...
      <View style={styles.messageContainer}>
        <Text style={styles.monthlyComment}>{monthlyComment}</Text>
